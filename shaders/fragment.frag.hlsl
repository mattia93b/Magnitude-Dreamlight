...
SPIRV_Cross_Output main(SPIRV_Cross_Input stage_input)
{
    ...
    uint index = (uint)stage_input.materialIndex;
    ...
    float3 specular = lightColor.xyz * (spec * matSpecular);
